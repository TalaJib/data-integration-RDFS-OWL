...
public class SPARQLQuerying {
	...
	public static void main(String[] args) {
		...
		Model schema = RDFDataMgr.loadModel("src/main/resources/owlDemoSchema.ttl", Lang.TURTLE);
		Model data = RDFDataMgr.loadModel("src/main/resources/owlDemoData.ttl", Lang.TURTLE);
