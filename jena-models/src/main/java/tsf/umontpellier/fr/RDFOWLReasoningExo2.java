...
public class RDFOWLReasoningExo2 {

    public static void main(String[] args) {
        // Load the schema and data models for Exercise 2
        Model schema = RDFDataMgr.loadModel("src/main/resources/owlExo2Schema.ttl", Lang.TURTLE);
        Model data = RDFDataMgr.loadModel("src/main/resources/owlExo2Data.ttl", Lang.TURTLE);
        ...
        System.out.println("\n\n========== EXERCICE 2 : Triples BEFORE inferences ==========\n");
        printTriples(data);

        System.out.println("\n\n========== EXERCICE 2 : INFERRED Triples ==========\n");
    ...
    static boolean isRelevantStatement(Statement stmt) {
        ...
        if (!SObanned.contains(subject.getNameSpace())) {
            ...
            if (object.isResource()) {
                ...
                if (SObanned.contains(o.getNameSpace())) return false;
            }
            return true;
        }
        return false;
